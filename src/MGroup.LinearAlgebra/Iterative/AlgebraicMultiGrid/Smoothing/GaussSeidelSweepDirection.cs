namespace MGroup.LinearAlgebra.Iterative.AlgebraicMultiGrid.Smoothing
{
	...
	public abstract class GaussSeidelSweepDirection
	{
		...
		public abstract void Apply(IGaussSeidelIteration _gsIteration, IExtendedReadOnlyVector rhs, IExtendedVector lhs);


		private class BackwardSweep : GaussSeidelSweepDirection
		{
			public override void Apply(IGaussSeidelIteration _gsIteration, IExtendedReadOnlyVector rhs, IExtendedVector lhs)
			{

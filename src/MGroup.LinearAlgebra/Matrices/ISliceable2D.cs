...
namespace MGroup.LinearAlgebra.Matrices
{
    ...
    public interface ISliceable2D: IIndexable2D
    {
        ...
        /// 0 &lt;= <paramref name="colIndex"/> &lt; <see cref="IBounded2D.NumColumns"/>.
        /// </param>
		...
		/// 0 &lt;= <paramref name="rowIndex"/> &lt; <see cref="IBounded2D.NumRows"/>.
		/// </param>
		/// <exception cref="IndexOutOfRangeException">
		...
		/// 0 &lt;= <paramref name="rowIndices"/>[i] &lt; <see cref="IBounded2D.NumRows"/>, for all i.
		/// </param>
		/// <param name="colIndices">
		/// The indices of the columns that will be returned in the submatrix. Constraints:
		/// 0 &lt;= <paramref name="colIndices"/>[j] &lt; <see cref="IBounded2D.NumColumns"/>, for all j.
		/// </param>
		/// <exception cref="IndexOutOfRangeException">
		...
		/// <paramref name="rowStartInclusive"/> &lt;= <paramref name="rowEndExclusive"/> &lt; <see cref="IBounded2D.NumRows"/>.
		/// </param>
		...
		/// <see cref="IBounded2D.NumColumns"/>.
		/// </param>
		/// <exception cref="IndexOutOfRangeException">

...
namespace MGroup.LinearAlgebra.Providers.MKL
{
    ...
    internal static class LapackePInvokes
    {
        ...
        ///     Overwritten by the factorization Values as follows: The Values on and above the diagonal contain the 
        ///     min(<paramref name="m"/>, <paramref name="n"/>)-by-<paramref name="n"/> upper trapezoidal matrix R (R is upper 
        ///     triangular if <paramref name="m"/> ≥ <paramref name="n"/>). The Values below the diagonal, with the array 
        ...
        ///     <paramref name="n"/>-by-<paramref name="n"/>, although the factorized Values only need 
        ...
        /// <param name="A">Array returned by <see cref="Dgeqrf(int, int, int, double[], int, double[])"/>. The Values on and 
        ///     above the diagonal contain the min(<paramref name="m"/>,p)-by-p upper trapezoidal matrix R (R is upper triangular 
        ///     if <paramref name="m"/> ≥ p) The Values below the diagonal, with the array <paramref name="Tau"/>, present the 
        ...
        ///     you must allocate enough space = <paramref name="m"/>-by-<paramref name="m"/>, although the factorized Values only
        ...
        /// <summary>
        /// MultiplyIntoResult an <paramref name="m"/>-by-<paramref name="n"/> (or vector) by the orthogonal matrix Q created by 
        ...
        /// <summary>
        /// MultiplyIntoResult an <paramref name="m"/>-by-<paramref name="n"/> matrix (or vector) by the orthogonal matrix Q created by 
        ...
        ///     If <paramref name="side"/> = <see cref="LAPACK_SIDE_RIGHT"/> : 0 ≤ <paramref name="k"/> ≤ <paramref name="n"/>.</param>
        /// <param name="A">Array returned by <see cref="Dgeqrf(int, int, int, double[], int, double[])"/>. The Values on and 
        ///     above the diagonal contain upper trapezoidal matrix R. The Values below the diagonal, with the array 

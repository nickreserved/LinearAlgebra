namespace MGroup.LinearAlgebra.Providers
{
    ...
    internal interface ILapackProvider
    {
        ...
        /// <summary>
        /// Matrix inversion using the factorized Values of 
        ...
        /// <summary>
        /// Linear system solution using the factorized Values of 
        ...
        /// <summary>
        /// Generates an m-by-n matrix holding the LQ factor Q, which has orthonormal columns, using the factorized Values of 
        ...
        /// <summary>
        /// Generates an m-by-n matrix holding the QR factor Q, which has orthonormal columns, using the factorized Values of 
        ...
        /// <summary>
        /// Multiplies the LQ factor Q with another matrix C, using the factorized Values of 
        /// <see cref="Dgelqf(int, int, double[], int, int, double[], int, double[], int, int, ref int)"/>.
        /// The matrix is general, stored in full column major format. See 
        ...
        /// <summary>
        /// Multiplies the QR factor Q with another matrix C, using the factorized Values of 
        /// <see cref="Dgeqrf(int, int, double[], int, int, double[], int, double[], int, int, ref int)"/>.
        /// The matrix is general, stored in full column major format. See 

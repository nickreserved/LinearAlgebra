namespace MGroup.LinearAlgebra.Tests.SchurComplements.SubmatrixExtractors
{
	...
	public static class SubmatrixExtractorCsrCscTests
	{
		[Fact]
		public static void TestClear()
		{
			var extractor = new SubmatrixExtractorCsrCsc();
		...
		private static void TestExtractorForExample(SubmatrixExtractorCsrCsc extractor, SchurComplementExample example)
		{

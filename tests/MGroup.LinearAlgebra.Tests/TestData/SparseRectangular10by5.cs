...
namespace MGroup.LinearAlgebra.Tests.TestData
{
	...
	internal static class SparseRectangular10by5
	{
		...
		internal static string FullFormatPath =>
			...
			+ @"\MGroup.LinearAlgebra.Tests\Resources\SparseRectangular10by5_FullFormat.txt";

		internal static string CsrArraysPath =>
			Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName
			+ @"\MGroup.LinearAlgebra.Tests\Resources\SparseRectangular10by5_CsrArrays.txt";

		internal static string CscArraysPath =>
			Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName
			+ @"\MGroup.LinearAlgebra.Tests\Resources\SparseRectangular10by5_CscArrays.txt";
		...
		internal static string CoordinateFormatPath =>
			Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName
			+ @"\MGroup.LinearAlgebra.Tests\Resources\SparseRectangular10by5_CoordinateFormat.txt";
	}
}
